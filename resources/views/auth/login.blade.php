<x-layout>
    <div class="mx-auto mt-12 w-full rounded-lg bg-white p-8 py-12 shadow-md md:max-w-xl">
        <h2 class="h2 mb-4 text-center text-4xl font-bold">Login</h2>
        <form method="POST" action="{{ route('login.authenticate') }}">
            ...
            <button type="submit"
                class="w-full bg-blue-500 px-4 py-2 text-white hover:bg-blue-600 focus:outline-none">Login</button>
